...
useEffect(() => {
  ...
  return (
   ...
   <main className="sm:ml-14 p-2 bg-slate-100 bg-[url('/w1.jpg')] bg-cover bg-center bg-no-repeat bg-fixed">
    <div className=" w-full h-auto flex items-center flex-row mb-4 mt-14 sm:mt-2">
      <div className='w-full h-auto flex items-center flex-row gap-4'>
        <h1 className=" w-auto h-auto text-2xl pl-3 pt-2 text-white font-bold"> LT4 Dashboard</h1>
    ...
    <section className="sm:justify-start grid grid-cols sm:grid-cols-3 gap-4 ">
      ...
      <Card className='bg-black/80 text-green-600'>
        <CardHeader className="pl-4 pr-4">
          ...
          <CardDescription className='text-white'>Vendas da(s) Loja(s), Cidade ou Estado </CardDescription>
        </CardHeader>
        <CardContent className="pl-4 pr-4">
        <div className="flex items-center justify-between flex-row">
          <div className="w-auto">            
            <div className="text-lg sm:text-[1.4vh] lg:text-lg">Vendido:</div>
            <div className="text-lg sm:text-[1.4vh] lg:text-lg">Recebido:</div>
            <div className="text-lg sm:text-[1.4vh] lg:text-lg">A Receber:</div>
          </div>

          <div className="w-auto">
            <div className="text-lg  sm:text-[1.4vh] sm:hidden lg:text-lg lg:block">R$:</div>
            <div className="text-lg  sm:text-[1.4vh] sm:hidden lg:text-lg lg:block">R$:</div>
            <div className="text-lg  sm:text-[1.4vh] sm:hidden lg:text-lg lg:block">R$:</div>
          </div>
            {loading ? (
              <div className="w-auto flex flex-col gap-2">
                ...
                <div className="h-5 w-24 bg-gray-300 rounded animate-pulse" />
                          ...
                          <div className="w-auto flex flex-col">            
                            <div className="text-lg sm:text-[1.4vh] lg:text-lg flex justify-end">{info[0].venda}</div>
                            <div className="text-lg sm:text-[1.4vh] lg:text-lg flex justify-end">{info[0].recebido}</div>
                            <div className="text-lg sm:text-[1.4vh] lg:text-lg flex justify-end">{info[0].areceber}</div>
